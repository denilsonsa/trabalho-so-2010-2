// This code is based on 0.1.2 version of:
// http://zanstra.com/my/Barcode/code128.js
// (downloaded on 2010-12-04)
//
// It has been modified to remove extra dependencies,
// but has also been refactored a bit.
...
function code128(code, barcodeType) {
	...
	return '<div class="bars">' + bar2html(a.join('')) + '</div><div class="label">' + code + '</div>'; 
}
...
function parseBarcode(barcode, barcodeType) {
	...
	var START_BASE = 38;
	var STOP       = 106; //BARS[STOP]==23311120 (manually added a zero at the end)
